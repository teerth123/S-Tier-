...
"[project]/node_modules/@rive-app/canvas/rive.js [app-client] (ecmascript)": ((__turbopack_context__) => {
                    ...
                    return function() {
                        ...
                        m.onRuntimeInitialized = function() {
                            ...
                            m.computeAlignment = function(e, f, g, n) {
                                let p = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 1.0;
                        ...
                        m.onRuntimeInitialized = function() {
                            ...
                            var t = m.RenderImage.extend("CanvasRenderImage", {
                                __construct: function() {
                                    let { la: q, xa: x } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
                                    this.__parent.__construct.call(this);
                                    this.Ka = k;
                                    k = k + 1 & 2147483647 || 1;
                                    this.la = q;
                            ...
                            m.RendererWrapper.prototype.align = function(q, x, F, I) {
                                let B = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 1.0;
                        ...
                        var Ya, Za, cb = {
                            ...
                            461518: ()=>void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
                            461622: ()=>{
                                try {
                            ...
                            464670: (a)=>window.h.ra(a).J.sampleRate,
                            464743: (a)=>{
                                a = window.h.ra(a);
                        ...
                        var Db = null, Eb = {}, Fb = [], Gb = 1, Hb = null, Ib = !0, O = null, Ab = {}, Kb = function(a) {
                            ...
                            for(var b;;){
                                if (a === a.parent) {
                                    return a = a.U.nb, b ? "/" !== a[a.length - 1] ? "".concat(a, "/").concat(b) : a + b : a;
                                }
                        ...
                        function Xc(a, b) {
                            ...
                            var d = b.name;
                            a || U('type "'.concat(d, '" must have a positive integer typeid pointer'));
                            if (Bc.hasOwnProperty(a)) {
                                if (c.$b) {
                                    return;
                                }
                                U("Cannot register type '".concat(d, "' twice"));
                            }
                            Bc[a] = b;
                            delete Uc[a];
                        ...
                        function $c(a, b, c) {
                            if (void 0 === a[b].B) {
                                var d = a[b];
                                a[b] = function() {
                                    a[b].B.hasOwnProperty(arguments.length) || U("Function '".concat(c, "' called with an invalid number of arguments (").concat(arguments.length, ") - expects one of (").concat(a[b].B, ")!"));
                        ...
                        function ad(a, b, c) {
                            m.hasOwnProperty(a) ? ((void 0 === c || void 0 !== m[a].B && void 0 !== m[a].B[c]) && U("Cannot register public name '".concat(a, "' twice")), $c(m, a, a), m.hasOwnProperty(c) && U("Cannot register multiple overloads of a function with the same number of arguments (".concat(c, ")!")), m[a].B[c] = b) : (m[a] = b, void 0 !== c && (m[a].Pc = c));
                        }
                        ...
                        function cd(a, b, c) {
                            for(; b !== c;){
                                b.na || U("Expected null or instance of ".concat(c.name, ", got an instance of ").concat(b.name)), a = b.na(a), b = b.A;
                            }
                            return a;
                        }
                        function dd(a, b) {
                            if (null === b) {
                                return this.Na && U("null is not a valid ".concat(this.name)), 0;
                            }
                            b.g || U('Cannot pass "'.concat(ed(b), '" as a ').concat(this.name));
                            b.g.o || U("Cannot pass deleted object as a pointer of type ".concat(this.name));
                            return cd(b.g.o, b.g.u.i, this.i);
                        }
                        function fd(a, b) {
                            if (null === b) {
                                this.Na && U("null is not a valid ".concat(this.name));
                                if (this.ua) {
                                    var c = this.Pa();
                            ...
                            b.g || U('Cannot pass "'.concat(ed(b), '" as a ').concat(this.name));
                            b.g.o || U("Cannot pass deleted object as a pointer of type ".concat(this.name));
                            !this.ta && b.g.u.ta && U("Cannot convert argument of type ".concat(b.g.L ? b.g.L.name : b.g.u.name, " to parameter type ").concat(this.name));
                            c = cd(b.g.o, b.g.u.i, this.i);
                            if (this.ua) {
                                switch(void 0 === b.g.G && U("Passing raw pointer to smart pointer is illegal"), this.tc){
                                    case 0:
                                        b.g.L === this ? c = b.g.G : U("Cannot convert argument of type ".concat(b.g.L ? b.g.L.name : b.g.u.name, " to parameter type ").concat(this.name));
                                        break;
                                    case 1:
                                        c = b.g.G;
                                        break;
                        ...
                        function gd(a, b) {
                            ...
                            b.g || U('Cannot pass "'.concat(ed(b), '" as a ').concat(this.name));
                            b.g.o || U("Cannot pass deleted object as a pointer of type ".concat(this.name));
                            b.g.u.ta && U("Cannot convert argument of type ".concat(b.g.u.name, " to parameter type ").concat(this.name));
                            return cd(b.g.o, b.g.u.i, this.i);
                        }
                        function hd(a, b, c, d) {
                            this.name = a;
                        ...
                        function Y(a, b) {
                            ...
                            "function" != typeof c && U("unknown function pointer with signature ".concat(a, ": ").concat(b));
                            return c;
                        }
                        var nd = void 0;
                        function od(a, b) {
                            ...
                            var d = [], e = {};
                            b.forEach(c);
                            throw new nd("".concat(a, ": ") + d.map(Cc).join([
                                ", "
                            ]));
                        }
                        function pd(a, b, c, d, e) {
                            ...
                            return function() {
                                arguments.length !== l && U("function ".concat(a, " called with ").concat(arguments.length, " arguments, expected ").concat(l, " args!"));
                                y.length = 0;
                                v.length = g ? 2 : 1;
                                v[0] = e;
                                if (g) {
                        ...
                        function td(a, b, c) {
                            a instanceof Object || U("".concat(c, ' with invalid "this": ').concat(a));
                            a instanceof b.i.constructor || U("".concat(c, ' incompatible with "this" of type ').concat(a.constructor.name));
                            a.g.o || U("cannot call emscripten binding method ".concat(c, " on deleted object"));
                        ...
                        var Xd = {
                            ...
                            _embind_create_inheriting_constructor: function(a, b, c) {
                                ...
                                a = oc(a, function() {
                                    e.A.rb.forEach((function(l) {
                                        if (this[l] === g[l]) {
                                            throw new uc("Pure virtual function ".concat(l, " must be implemented in JavaScript"));
                                        }
                                    }).bind(this));
                                ...
                                f.__construct = function() {
                                    ...
                                    l = u.o;
                                    l = Ac(e, l);
                                    zc.hasOwnProperty(l) ? U("Tried to register registered instance: ".concat(l)) : zc[l] = this;
                                };
                                f.__destruct = function() {
                                    ...
                                    var l = this.g.o;
                                    l = Ac(e, l);
                                    zc.hasOwnProperty(l) ? delete zc[l] : U("Tried to unregister unregistered instance: ".concat(l));
                                };
                            ...
                            _embind_register_class: function(a, b, c, d, e, f, g, n, p, l, u, v, y) {
                                ...
                                var k = nc(u);
                                ad(k, function() {
                                    od("Cannot construct ".concat(u, " due to unbound types"), [
                                        d
                                    ]);
                                });
                                W([
                                    ...
                                    t = oc(k, function() {
                                        ...
                                        if (void 0 === T) {
                                            throw new qc("Tried to invoke ctor of ".concat(u, " with invalid number of parameters (").concat(arguments.length, ") - expected (").concat(Object.keys(w.$).toString(), ") parameters instead!"));
                                        }
                            ...
                            _embind_register_class_class_function: function(a, b, c, d, e, f, g) {
                                ...
                                W([], [
                                    ...
                                    function l() {
                                        od("Cannot call ".concat(u, " due to unbound types"), n);
                                    }
                                    p = p[0];
                            ...
                            _embind_register_class_class_property: function(a, b, c, d, e, f, g, n) {
                                ...
                                W([], [
                                    ...
                                    p = p[0];
                                    var l = "".concat(p.name, ".").concat(b), u = {
                                        get () {
                                            od("Cannot access ".concat(l, " due to unbound types"), [
                                                c
                                            ]);
                                        },
                                        enumerable: !0,
                                    ...
                                    u.set = n ? ()=>{
                                        ...
                                        U("".concat(l, " is a read-only property"));
                                    };
                            ...
                            _embind_register_class_constructor: function(a, b, c, d, e, f) {
                                ...
                                W([], [
                                    ...
                                    void 0 === n.i.$ && (n.i.$ = []);
                                    if (void 0 !== n.i.$[b - 1]) {
                                        throw new qc("Cannot register multiple constructors with identical number of parameters (".concat(b - 1, ") for class '").concat(n.name, "'! Overload resolution is currently only performed using the parameter count, not actual type info!"));
                                    }
                                    n.i.$[b - 1] = ()=>{
                                        od("Cannot construct ".concat(n.name, " due to unbound types"), g);
                                    };
                                    W([], g, function(l) {
                                        l.splice(1, 0, null);
                            ...
                            _embind_register_class_function: function(a, b, c, d, e, f, g, n) {
                                ...
                                W([], [
                                    ...
                                    function u() {
                                        od("Cannot call ".concat(v, " due to unbound types"), p);
                                    }
                                    l = l[0];
                            ...
                            _embind_register_class_property: function(a, b, c, d, e, f, g, n, p, l) {
                                ...
                                W([], [
                                    ...
                                    u = u[0];
                                    var v = "".concat(u.name, ".").concat(b), y = {
                                        get () {
                                            od("Cannot access ".concat(v, " due to unbound types"), [
                                                c,
                                                g
                                            ]);
                                        },
                            ...
                            _embind_register_enum_value: function(a, b, c) {
                                ...
                                d = Object.create(d.constructor.prototype, {
                                    ...
                                    constructor: {
                                        value: oc("".concat(d.name, "_").concat(b), function() {})
                                    }
                                });
                                a.values[c] = d;
                                a[b] = d;
                            ...
                            _embind_register_function: function(a, b, c, d, e, f) {
                                ...
                                e = Y(d, e);
                                ad(a, function() {
                                    od("Cannot call ".concat(a, " due to unbound types"), g);
                                }, b - 1);
                                W([], g, function(n) {
                                    jd(a, pd(a, [
                                        n[0],
                            ...
                            _embind_register_std_wstring: function(a, b, c) {
                                ...
                                Vc(a, {
                                    ...
                                    toWireType: function(p, l) {
                                        "string" != typeof l && U("Cannot pass non-string to C++ string type ".concat(c));
...
"[project]/node_modules/@rive-app/react-canvas/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
var e = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), n = __turbopack_context__.r("[project]/node_modules/@rive-app/canvas/rive.js [app-client] (ecmascript)");
function t(e) {
    ...
    return e.useEffect({
        "l.useEffect": function() {
            if ("undefined" != typeof window && "matchMedia" in window) {
                var e = {
                    "l.useEffect.e": function() {
                        var e = n || c();
                        a(e);
                    }
                }["l.useEffect.e"], t = window.matchMedia("screen and (resolution: ".concat(u, "dppx)"));
...
function p(n, t) {
    ...
    var i, o, l, c = e.useRef(new f((i = ({
        "p.useRef[c]": function(e) {
            d && a({
    ...
    return e.useEffect({
        "p.useEffect": function() {
            ...
            if (t) {
                var r = n.current;
                return n.current && d && e.observe(n.current), ({
                    "p.useEffect": function() {
...
function g(n) {
    var t = n.riveLoaded, r = void 0 !== t && t, u = n.canvasElem, a = n.containerRef, i = n.options, o = void 0 === i ? {} : i, c = n.onCanvasHasResized, s = n.artboardBounds, f = b(o), d = e.useState({
        ...
        height: 0,
        width: 0
    }), m = w[0], C = m.height, R = m.width, E = w[1], V = e.useState(!0), x = V[0], k = V[1], O = f.fitCanvasToArtboardHeight, I = f.shouldResizeCanvasToContainer, P = f.useDevicePixelRatio, M = f.customDevicePixelRatio, T = p(a, I), S = l(M), D = null != s ? s : {}, L = D.maxX, A = D.maxY, z = e.useCallback({
        "g.useCallback[z]": function() {
...
function V(t, i) {
    void 0 === i && (i = {});
    var o = e.useState(null), c = o[0], s = o[1], f = e.useRef(null), d = e.useRef(null), v = e.useState(null), p = v[0], h = v[1], y = Boolean(t), w = b(i), m = l(), C = e.useCallback({
        "V.useCallback[C]": function() {
            if (p) {
            ...
            if (c && t) {
                ...
                if (null == p) {
                    ...
                    e = new n.Rive(u(u({
                        ...
                        canvas: c
                    })), null != d.current && d.current.cleanup(), d.current = e, e.on(n.EventType.Load, {
                        "V.useEffect": function() {
    ...
    e.useEffect({
        "V.useEffect": function() {
            ...
            return c && !1 !== w.shouldUseIntersectionObserver && O(c, {
                "V.useEffect": function(r) {
...
function x(n, t, r) {
    ...
    var g = e.useCallback({
        "x.useCallback[g]": function() {
            var e = p.current, n = h.current, t = b.current;
            if (!e || !n) return o(null), s(t.defaultValue), v(null), ({
                "x.useCallback[g]": function() {}
            })["x.useCallback[g]"];
...
exports.default = function(e) {
    ...
    var r = x(n, t, {
        ...
        defaultValue: null,
        buildPropertyOperations: e.useCallback({
            "r.useCallback": function(e) {
                return {
                    setValue: ({
        ...
        buildPropertyOperations: e.useCallback({
            "r.useCallback": function(e) {
                return {
                    ...
                    setRgba: ({
                        "r.useCallback": function(n, t, r, u) {
                            e({
                                "r.useCallback": function(e) {
                                    e.rgba(n, t, r, u);
                                }
...
//# sourceMappingURL=node_modules_7cb82ce2._.js.map